...
const NAV: NavGroup[] = [
  ...
  },
  {
    ...
    entries: [
      ...
      { label: 'Gift cards', href: '/admin/gift-cards', icon: Gift, permission: 'order.read' },
  ...
  },
  {
    ...
    entries: [
      ...
      { label: 'Collections', href: '/admin/collections', icon: Layers, permission: 'content.read' },
      { label: 'Showcase', href: '/admin/showcase', icon: Clapperboard, permission: 'content.read' },
    ],
  },
